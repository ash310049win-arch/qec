...
export type CountryData = {
  ...
  /** Annual cost estimate in INR shown in the Course Finder ("From ₹X/yr"). Optional; the quiz hides the price line when absent. */
  matcherMinBudget?: number
  heroImage: string
  headline: string
  eyebrow: string
  tagline: string
