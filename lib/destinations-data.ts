...
export const COUNTRIES: CountryData[] = [
  {
    ...
    heroCards: [
      ...
      },
      {
        ...
        alt: "Osaka Dotonbori street at night",
        vertical: true,
      },
      {
        label: "Top Universities",
        image: "/images/dest-japan-3.jpg",
        alt: "University of Tokyo campus building",
        vertical: true,
      },
      {
        label: "Student Life",
        image: "/images/dest-japan-4.jpg",
        alt: "Shibuya crossing with students",
      },
    ],
    whyTitle: "Why Japan?",
    whyPoints: [
    ...
    heroCards: [
      {
        ...
        alt: "Big Ben and Westminster, London",
      },
      {
        label: "Top Universities",
      ...
      },
      {
        ...
        alt: "Radcliffe Camera, Oxford",
        vertical: true,
      },
      {
        label: "The Thames",
        image: "/images/dest-uk-4.jpg",
        alt: "London skyline on the Thames",
      },
    ],
    whyTitle: "Why the UK?",
    whyPoints: [
  ...
  },
  {
    ...
    heroCards: [
      ...
      },
      {
        ...
        alt: "Munich skyline with Frauenkirche",
        vertical: true,
      },
      {
        label: "Bavaria",
    ...
    heroCards: [
      {
        ...
        alt: "O'Connell Street, Dublin",
      },
      {
        label: "Top Universities",
        image: "/images/dest-ireland-1.jpg",
        alt: "Trinity College Dublin's Long Room library",
        vertical: true,
      },
      {
        label: "The Wild Coast",
      ...
      },
      {
        ...
        alt: "Ha'penny Bridge over the Liffey, Dublin",
      },
    ],
    ...
    heroCards: [
      {
        ...
        alt: "Lake and mountains near Queenstown",
      },
      {
        label: "Top Universities",
        image: "/images/dest-new-zealand-2.jpg",
        alt: "University of Auckland campus",
        vertical: true,
      },
      {
        label: "Auckland",
  ...
  },
  {
    ...
    heroCards: [
      ...
      },
      {
        ...
        alt: "Sorbonne University, Paris",
        vertical: true,
      },
      {
        label: "Landmarks",
        image: "/images/dest-france-2.jpg",
        alt: "Louvre Pyramid, Paris",
        vertical: true,
      },
      {
        label: "The Seine",
        image: "/images/dest-france-4.jpg",
        alt: "Paris skyline along the Seine",
      },
    ],
    whyTitle: "Why France?",
    whyPoints: [
  ...
  },
  {
    ...
    heroCards: [
      ...
      },
      {
        ...
        alt: "Rotterdam skyline and Erasmus bridge",
      },
    ],
  ...
  },
  {
    ...
    heroCards: [
      ...
      },
      {
        ...
        alt: "National University of Singapore campus",
        vertical: true,
      },
      {
        label: "The Merlion",
        image: "/images/dest-singapore-2.jpg",
        alt: "Merlion statue, Singapore",
        vertical: true,
      },
      {
        label: "The Skyline",
    ...
    heroCards: [
      {
        ...
        alt: "Warsaw city skyline",
      },
      {
        label: "Top Universities",
        image: "/images/dest-poland-2.jpg",
        alt: "Jagiellonian University, Kraków",
        vertical: true,
      },
      {
        label: "Kraków",
        image: "/images/dest-poland-3.jpg",
        alt: "Wawel Castle, Kraków",
        vertical: true,
      },
      {
        label: "Old Town",
