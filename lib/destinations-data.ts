...
export const COUNTRIES: CountryData[] = [
    ...
    heroCards: [
      {
        ...
        alt: "Yasuda Auditorium at the University of Tokyo",
      },
      {
        label: "Waseda & Keio",
        image: "/images/dest-japan-2.jpg",
        alt: "Campus of Waseda University in Tokyo",
        vertical: true,
      },
      {
        label: "Kyoto University",
        image: "/images/dest-japan-3.jpg",
        alt: "Campus building at Kyoto University",
        vertical: true,
      },
      {
        label: "Student Life",
        image: "/images/dest-japan-4.jpg",
        alt: "Students studying in a Japanese university library",
      },
    ],
    whyTitle: "Why Japan?",
    whyPoints: [
    ...
    heroCards: [
      {
        ...
        alt: "Harvard Yard at Harvard University",
      },
      {
        label: "MIT",
        image: "/images/dest-usa-3.jpg",
        alt: "Great Dome of MIT in Cambridge, Massachusetts",
        vertical: true,
      },
      {
        label: "Stanford",
        image: "/images/dest-usa-2.jpg",
        alt: "Campus of Stanford University in California",
        vertical: true,
      },
      {
        label: "Campus Life",
        image: "/images/dest-usa-4.jpg",
        alt: "Students walking across an American university campus",
      },
    ],
  ...
  },
  {
    ...
    heroCards: [
      ...
      },
      {
        ...
        alt: "Campus of the University of British Columbia",
        vertical: true,
      },
      {
        label: "McGill",
        image: "/images/dest-canada-2.jpg",
        alt: "Campus of McGill University in Montreal",
        vertical: true,
      },
      {
        label: "Campus Life",
        image: "/images/dest-canada-4.jpg",
        alt: "Students studying on a Canadian university campus",
      },
    ],
    whyTitle: "Why Canada?",
    whyPoints: [
    ...
    heroCards: [
      {
        ...
        alt: "King's College Chapel at the University of Cambridge",
      },
      {
        label: "Oxford",
      ...
      },
      {
        ...
        alt: "Historic quadrangle at a British university",
        vertical: true,
      },
      {
        label: "Campus Life",
        image: "/images/dest-uk-4.jpg",
        alt: "Students studying in a British university library",
      },
    ],
    whyTitle: "Why the UK?",
    whyPoints: [
    ...
    heroCards: [
      {
        ...
        alt: "Quadrangle at the University of Sydney",
      },
      {
        label: "Top Universities",
        image: "/images/dest-australia-2.jpg",
        alt: "Campus of the University of Melbourne",
        vertical: true,
      },
      {
        label: "Group of Eight",
        image: "/images/dest-australia-3.jpg",
        alt: "Historic building on an Australian university campus",
        vertical: true,
      },
      {
        label: "Campus Life",
        image: "/images/dest-australia-4.jpg",
        alt: "Students studying on an Australian university campus",
      },
    ],
    ...
    heroCards: [
      {
        ...
        alt: "Main building of the Technical University of Munich",
      },
      {
        label: "Heidelberg",
        image: "/images/dest-germany-3.jpg",
        alt: "Old campus of Heidelberg University",
        vertical: true,
      },
      {
        label: "RWTH Aachen",
        image: "/images/dest-germany-2.jpg",
        alt: "Campus of RWTH Aachen University",
        vertical: true,
      },
      {
        label: "Campus Life",
        image: "/images/dest-germany-4.jpg",
        alt: "Students studying at a German university",
      },
    ],
    ...
    heroCards: [
      {
        ...
        alt: "Campus of University College Dublin",
      },
      {
        label: "Trinity College",
        image: "/images/dest-ireland-1.jpg",
        alt: "Long Room library at Trinity College Dublin",
        vertical: true,
      },
      {
        label: "NUI Galway",
        image: "/images/dest-ireland-2.jpg",
        alt: "Campus of NUI Galway",
        vertical: true,
      },
      {
        label: "Campus Life",
        image: "/images/dest-ireland-3.jpg",
        alt: "Students at an Irish university campus",
      },
    ],
  ...
  },
  {
    ...
    heroCards: [
      ...
      },
      {
        ...
        alt: "Campus of the University of Auckland",
        vertical: true,
      },
      {
        label: "Victoria University",
        image: "/images/dest-new-zealand-3.jpg",
        alt: "Campus of Victoria University of Wellington",
        vertical: true,
      },
      {
        label: "Campus Life",
        image: "/images/dest-new-zealand-1.jpg",
        alt: "Students studying at a New Zealand university",
      },
    ],
    ...
    heroCards: [
      {
        ...
        alt: "Chapel of the Sorbonne in Paris",
      },
      {
        label: "Top Universities",
        image: "/images/dest-france-3.jpg",
        alt: "Campus of Sorbonne University, Paris",
        vertical: true,
      },
      {
        label: "École Polytechnique",
        image: "/images/dest-france-2.jpg",
        alt: "Campus of École Polytechnique in Palaiseau",
        vertical: true,
      },
      {
        label: "Campus Life",
        image: "/images/dest-france-4.jpg",
        alt: "Students at a French university campus",
      },
    ],
    whyTitle: "Why France?",
    whyPoints: [
    ...
    heroCards: [
      {
        ...
        alt: "Campus of the University of Amsterdam",
      },
      {
        label: "TU Delft",
        image: "/images/dest-netherlands-2.jpg",
        alt: "Campus of TU Delft",
        vertical: true,
      },
      {
        label: "Leiden",
        image: "/images/dest-netherlands-3.jpg",
        alt: "Academy building of Leiden University",
        vertical: true,
      },
      {
        label: "Campus Life",
        image: "/images/dest-netherlands-4.jpg",
        alt: "Students cycling on a Dutch university campus",
      },
    ],
    ...
    heroCards: [
      {
        ...
        alt: "Campus of Khalifa University in Abu Dhabi",
      },
      {
        label: "UAE University",
        image: "/images/dest-uae-2.jpg",
        alt: "Campus of United Arab Emirates University in Al Ain",
        vertical: true,
      },
      {
        label: "AUS Sharjah",
        image: "/images/dest-uae-3.jpg",
        alt: "American University of Sharjah campus",
        vertical: true,
      },
      {
        label: "Campus Life",
        image: "/images/dest-uae-4.jpg",
        alt: "Students on a UAE university campus",
      },
    ],
  ...
  },
  {
    ...
    heroCards: [
      {
        label: "Seoul National",
        image: "/images/dest-south-korea-1.jpg",
        alt: "Campus of Seoul National University",
      },
      {
        label: "KAIST",
        image: "/images/dest-south-korea-3.jpg",
        alt: "Campus of KAIST in Daejeon",
        vertical: true,
      },
      {
        label: "Yonsei",
        image: "/images/dest-south-korea-2.jpg",
        alt: "Campus of Yonsei University in Seoul",
        vertical: true,
      },
      {
        label: "Campus Life",
        image: "/images/dest-south-korea-4.jpg",
        alt: "Students studying at a Korean university",
      },
    ],
    ...
    heroCards: [
      {
        ...
        alt: "Campus of the National University of Singapore",
      },
      {
        label: "NTU",
        image: "/images/dest-singapore-3.jpg",
        alt: "Campus of Nanyang Technological University",
        vertical: true,
      },
      {
        label: "SMU",
        image: "/images/dest-singapore-2.jpg",
        alt: "Campus of Singapore Management University",
        vertical: true,
      },
      {
        label: "Campus Life",
        image: "/images/dest-singapore-4.jpg",
        alt: "Students on a Singapore university campus",
      },
    ],
    ...
    heroCards: [
      {
        ...
        alt: "Campus of the University of Warsaw",
      },
      {
        label: "Jagiellonian",
        image: "/images/dest-poland-2.jpg",
        alt: "Collegium Maius at Jagiellonian University, Kraków",
        vertical: true,
      },
      {
        label: "Warsaw Tech",
        image: "/images/dest-poland-3.jpg",
        alt: "Campus of Warsaw University of Technology",
        vertical: true,
      },
      {
        label: "Campus Life",
        image: "/images/dest-poland-4.jpg",
        alt: "Students studying at a Polish university",
      },
    ],
    whyTitle: "Why Poland?",
    whyPoints: [
    ...
    heroCards: [
      {
        ...
        alt: "Campus of Universiti Malaya in Kuala Lumpur",
      },
      {
        label: "Top Universities",
        image: "/images/dest-malaysia-2.jpg",
        alt: "Campus of Universiti Kebangsaan Malaysia",
        vertical: true,
      },
      {
        label: "Monash Malaysia",
        image: "/images/dest-malaysia-3.jpg",
        alt: "Campus of Monash University Malaysia",
        vertical: true,
      },
      {
        label: "Campus Life",
        image: "/images/dest-malaysia-4.jpg",
        alt: "Students on a Malaysian university campus",
      },
    ],
