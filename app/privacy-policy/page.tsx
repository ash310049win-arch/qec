    ...
    <section className="bg-accent pt-28 pb-16 lg:pt-36 lg:pb-20">
      <div className="mx-auto max-w-7xl px-6 text-center">
        ...
        <p className="animate-fade-up-delay-1 mx-auto mt-4 max-w-2xl text-accent-foreground/70 leading-relaxed text-pretty">
          How Quilon Educational Consultancy Pvt Ltd collects, uses, and protects your personal
          information.
        </p>
      </div>
    </section>
...
function SubSection({ title, children }: { title: string; children: ReactNode }) {
  return (
    <div>
      ...
      <div className="mt-2 flex flex-col gap-3 text-muted-foreground leading-relaxed">{children}</div>
    </div>
  )
}
      ...
      <ul className="flex flex-col gap-3 text-sm">
        <li className="flex items-start gap-3">
          ...
          <span>
            ...
            ,{" "}
            <a href="mailto:sunil2balan@gmail.com" className="text-primary hover:underline">
              sunil2balan@gmail.com
            </a>
          </span>
        </li>
        <li className="flex items-start gap-3">
          ...
          <span>
            ...
            <a
              href="https://quilonconsultancy.com/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-primary hover:underline"
            >
              https://quilonconsultancy.com/
            </a>
          </span>
        </li>
        <li className="flex items-start gap-3">
          <Phone className="mt-0.5 h-4 w-4 shrink-0 text-primary" />
          <span>By phone number: 09207774401, 9497771392, 9400163111</span>
        </li>
      </ul>
    </Section>
  )
          ...
          <div className="mt-0 flex flex-col gap-12">
            ...
            <Section title="Interpretation and Definitions">
              ...
              <SubSection title="Definitions">
                ...
                <ul className="list-disc pl-6 space-y-3">
                  <li>
                    <strong className="font-semibold text-foreground">Account</strong> means a unique
                    account created for You to access our Service or parts of our Service.
                  </li>
                  <li>
                    <strong className="font-semibold text-foreground">Affiliate</strong> means an
                  ...
                  <li>
                    <strong className="font-semibold text-foreground">Company</strong> (referred to as
                    either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot;
                    in this Agreement) refers to Quilon Educational Consultancy Pvt Ltd, Building No
                    6/730, Kunnumpurathu Building, Ampalakara P O, Valakom, Kottarakara, Kollam,
                    Kerala - 691532.
                  </li>
                  <li>
                    <strong className="font-semibold text-foreground">Cookies</strong> are small files
                    that are placed on Your computer, mobile device or any other device by a website,
                  ...
                  <li>
                    <strong className="font-semibold text-foreground">Device</strong> means any device
                  ...
                  <li>
                    <strong className="font-semibold text-foreground">Service Provider</strong> means
                    ...
                    perform services related to the Service or to assist the Company in analyzing how
                    the Service is used.
                  </li>
                  <li>
                    <strong className="font-semibold text-foreground">Third-party Social Media
                    Service</strong> refers to any website or any social network website through which
                    a User can log in or create an account to use the Service.
                  </li>
                  <li>
                    <strong className="font-semibold text-foreground">Usage Data</strong> refers to
                  ...
                  <li>
                    <strong className="font-semibold text-foreground">Website</strong> refers to Quilon
                    Educational consultancy Private Limited, accessible from{" "}
                    <a
                      href="https://quilonconsultancy.com/"
                      target="_blank"
                      rel="noopener noreferrer"
                  ...
                  <li>
                    <strong className="font-semibold text-foreground">You</strong> means the
                    individual accessing or using the Service, or the company, or other legal entity
                    on behalf of which such individual is accessing or using the Service, as
                    applicable.
                  </li>
                </ul>
              </SubSection>
            ...
            <Section title="Collecting and Using Your Personal Data">
              <SubSection title="Types of Data Collected">
                <h4 className="font-heading text-base font-bold text-foreground">Personal Data</h4>
                <p>
                ...
                <h4 className="mt-2 font-heading text-base font-bold text-foreground">Usage Data</h4>
              ...
              <SubSection title="Tracking Technologies and Cookies">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong className="font-semibold text-foreground">Cookies or Browser Cookies.</strong>{" "}
                  ...
                  <li>
                    <strong className="font-semibold text-foreground">Web Beacons.</strong> Certain
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong className="font-semibold text-foreground">Necessary / Essential
                    Cookies</strong>
                    <br />
                  ...
                  <li>
                    <strong className="font-semibold text-foreground">Cookies Policy / Notice
                  ...
                  <li>
                    <strong className="font-semibold text-foreground">Functionality Cookies</strong>
                    <br />
                    Type: Persistent Cookies
                    <br />
                    Administered by: Us
              ...
              <SubSection title="Use of Your Personal Data">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    <strong className="font-semibold text-foreground">To manage Your Account:</strong>{" "}
                  ...
                  <li>
                    <strong className="font-semibold text-foreground">For the performance of a
                    contract:</strong> the development, compliance and undertaking of the purchase
                    contract for the products, items or services You have purchased or of any other
                    contract with Us through the Service.
                  </li>
                  <li>
                    <strong className="font-semibold text-foreground">To contact You:</strong> To
                    ...
                    contracted services, including the security updates, when necessary or reasonable
                  ...
                  <li>
                    <strong className="font-semibold text-foreground">To manage Your requests:</strong>{" "}
                    To attend and manage Your requests to Us.
                  </li>
                  <li>
                    <strong className="font-semibold text-foreground">For business transfers:</strong>{" "}
                  ...
                  <li>
                    <strong className="font-semibold text-foreground">For other purposes:</strong> We
                    may use Your information for other purposes, such as data analysis, identifying
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    <strong className="font-semibold text-foreground">With Affiliates:</strong> We may
                    ...
                    any other subsidiaries, joint venture partners or other companies that We control
                    or that are under common control with Us.
                  </li>
                  <li>
                    <strong className="font-semibold text-foreground">With business partners:</strong>{" "}
                    We may share Your information with Our business partners to offer You certain
                    products, services or promotions.
                  </li>
                  <li>
                    <strong className="font-semibold text-foreground">With other users:</strong> when
                  ...
                  <li>
                    <strong className="font-semibold text-foreground">With Your consent:</strong> We
